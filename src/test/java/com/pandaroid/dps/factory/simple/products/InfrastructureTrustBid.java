 ...
 */
public class InfrastructureTrustBid extends ATrustBid implements ITrustBid {

    public InfrastructureTrustBid(String trustBidMemo) {
        super(trustBidMemo);
    }

    @Override
    public void pubTrustBid() {
        System.out.println("[InfrastructureTrustBid: " + trustBidMemo + "]发布信托标的：基础设施类信托。" + this.toString());
    }
}
